    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.99902 10.4951C6.82745 10.4951 7.49902 11.1667 7.49902 11.9951V12.0051C7.49902 12.8335 6.82745 13.5051 5.99902 13.5051C5.1706 13.5051 4.49902 12.8335 4.49902 12.0051V11.9951C4.49902 11.1667 5.1706 10.4951 5.99902 10.4951ZM17.999 10.4951C18.8275 10.4951 19.499 11.1667 19.499 11.9951V12.0051C19.499 12.8335 18.8275 13.5051 17.999 13.5051C17.1706 13.5051 16.499 12.8335 16.499 12.0051V11.9951C16.499 11.1667 17.1706 10.4951 17.999 10.4951ZM13.499 11.9951C13.499 11.1667 12.8275 10.4951 11.999 10.4951C11.1706 10.4951 10.499 11.9951 10.499 11.9951V12.0051C10.499 12.8335 11.1706 13.5051 11.999 13.5051C12.8275 13.5051 13.499 12.8335 13.499 11.9951Z"
              fill="currentColor"
            />
          </svg>
        </button>
      ...
      >
        <div class="flex items-center gap-2 2xsm:gap-3">
          <ThemeToggler />
          <!-- §4.3：＋ 导入资料 为唯一全局导入按钮；V1 免登录不展示虚假用户/通知菜单 -->
          <Button
            size="sm"
            variant="primary"
            class="!px-4 !py-2.5"
